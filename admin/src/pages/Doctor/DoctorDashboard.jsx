    ...
    <div className='m-5'>
      <div className="flex flex-wrap gap-5">
        <div className="flex items-center gap-4 bg-white p-5 min-w-82.5 flex-1 rounded-xl border shadow-sm hover:shadow-md hover:-translate-y-1 transition">
          ...
          <div> <p className="text-2xl font-semibold text-gray-800">{currency} {dashData.earnings} </p>
      ...
      <div className="bg-white rounded-xl border shadow-sm">
        <div className="flex items-center gap-2.5 px-4 py-4 border-b bg-gray-50 rounded-t-xl">
